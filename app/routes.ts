...
export default [
  ...
  route("history/all-play", "routes/all-play.tsx"),
  route("history/drafts", "routes/drafts.tsx"),
  route("history/transactions", "routes/transactions.tsx"),
  route("history/team-names", "routes/team-names.tsx"),
